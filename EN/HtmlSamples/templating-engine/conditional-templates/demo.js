...
$ ${UnitPrice} 
        ...
        <img width='10' height='15' src= 'http://staging.igniteui.local/14-2/images/samples/templating-engine/colTemplateWithConditionalCell/arrowUp.gif' />
        {{else}}
        <img width='10' height='15' src= 'http://staging.igniteui.local/14-2/images/samples/templating-engine/colTemplateWithConditionalCell/arrowDown.gif' />
        {{/if}}
